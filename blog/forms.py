...
class LoginForm(AuthenticationForm):
    ...
    username = forms.CharField(label='User Name Here',widget=forms.TextInput(attrs={'class':'form-control'}))
    password = forms.CharField(label='Password Here',widget=forms.PasswordInput(attrs={'class':'form-control'}))
